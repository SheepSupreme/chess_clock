...
class OLED
{
  ...
  public:
    // 'Background', 128x64px
    const unsigned char epd_bitmap_Background [] = {
    ...
    // 'Ebene 1', 74x43px
    const unsigned char epd_bitmap_Ebene_1 [] = {
    ...
    const unsigned char epd_bitmap_Ebene_2_2 [] = {
    ...
    const unsigned char epd_bitmap_Ebene_2_1 [] = {
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    // 'Ebene 2', 74x20px
    const unsigned char epd_bitmap_Ebene_2_0 [] = {
